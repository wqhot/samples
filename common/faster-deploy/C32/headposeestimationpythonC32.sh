...
main()
{
	...
	cp -r $HOME/AscendProjects/samples/sample-headposeestimation-python $HOME/AscendProjects/
    if [[ $? -ne 0 ]];then
    ...
    download "head_pose_estimation"  "1"

    echo "[INFO] Please follow the link from the deployment environment step in Readme to continue running the case.(https://gitee.com/ascend/samples.git)"
}
main
