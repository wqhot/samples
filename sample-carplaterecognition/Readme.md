...
2.  <a name="zh-cn_topic_0228461932_li3208251440"></a>常规部署，请参考：  [https://gitee.com/ascend/samples/tree/1.32.0.0/common/sample-README/sample-carplaterecognition](https://gitee.com/ascend/samples/tree/1.32.0.0/common/sample-README/sample-carplaterecognition)  。
...
2.  使用启动Presenter Server服务时提示的URL登录 Presenter Server 网站。
    ...
    **图 11**  Presenter Server界面<a name="zh-cn_topic_0228461932_zh-cn_topic_0218873008_fig113691556202312"></a>  
